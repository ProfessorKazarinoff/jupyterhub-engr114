...
extra_users = ['peter.marchineio', 'test.student2', 'faculty.name2', 'test.student3']
...
def clone_repo(user,
    ...
    :param user: str, jupyter hub username ex: peter.marchineio
...
c.ConfigurableHTTPProxy.auth_token = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
...
c.LocalGoogleOAuthenticator.oauth_client_id = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX.apps.googleusercontent.com'

c.LocalGoogleOAuthenticator.oauth_client_secret = 'UWcOfNihh6qoJGpUjNovAG1P'
c.Authenticator.add_user_cmd = ['adduser', '-q', '--gecos', '""', '--disabled-password', '--force-badname']
# c.Authenticator.whitelist = {'peter.marchineio','peter','test.student3','test.student2','first.last'}
c.Authenticator.admin_users = {'peter.marchineio'}
...
def user_lst_from_email_roster(txt_file):
    ...
    :return: set, a set of usernames ex: {peter.marchineio, nelly.manning, jess.rod2}
    """
